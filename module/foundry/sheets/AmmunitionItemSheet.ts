import AmmunitionApp from "@apps/AmmunitionApp.svelte";
import { Sr3eItemSheetBase } from "./Sr3eItemSheetBase";
import { localize } from "@services/utilities.js";
import type { Component } from "svelte";

export default class AmmunitionItemSheet extends Sr3eItemSheetBase {
  ...
  static override get DEFAULT_OPTIONS(): foundry.applications.types.ApplicationConfiguration {
    return {
      ...
      classes: [...(super.DEFAULT_OPTIONS.classes ?? []), "ammunition"],
    };
  }

  protected getSvelteComponent(): Component {
    return AmmunitionApp;
  }
}
