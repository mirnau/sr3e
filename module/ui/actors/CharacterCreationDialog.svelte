...
<form onsubmit={handleSubmit}>
   <div class="sr3e-waterfall-wrapper">
      <div class="sr3e-waterfall sr3e-waterfall--double">
         ...
         <div class="item-sheet-component">
            <div class="sr3e-inner-background-container">
               ...
               <div class="sr3e-inner-background">
                  ...
                  <div>Height: {characterHeight}</div>
                  <input
                     type="range"
                     min={(metatypeItem?.system as any)?.physical?.height
                        ?.min ?? 0}
                     max={(metatypeItem?.system as any)?.physical?.height
                        ?.max ?? 200}
                     step="1"
                     bind:value={characterHeight}
                  />

                  <div>Weight: {characterWeight}</div>
                  <input
                     type="range"
                     min={(metatypeItem?.system as any)?.physical?.weight
                        ?.min ?? 0}
                     max={(metatypeItem?.system as any)?.physical?.weight
                        ?.max ?? 200}
                     step="1"
