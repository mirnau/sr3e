<script lang="ts">
    ...
    const readWrite = $derived(Math.floor($valueStore / 2));
    ...
    $effect(() => {
        const rw = Math.floor($valueStore / 2);
    ...
    <div class="sr3e-waterfall sr3e-waterfall--single">
            ...
            <div class="sr3e-inner-background-container">
                ...
                <div class="sr3e-inner-background">
                    ...
                    <div class="stat-grid single-column">
                        ...
                        <!-- Read/Write derived value -->
                        <div class="stat-card">
                            <div class="stat-card-background"></div>
                            <div class="skill-specialization-card">
                                <div class="specialization-background"></div>
                                <h6>{localize("SR3E.skill.readwrite")}:</h6>
                                <h1 class="embedded-value">{readWrite}</h1>
                            </div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-card-background"></div>
                            <div class="buttons-horizontal-distribution">
                                ...
                                >
                                    {localize(CONFIG.SR3E.SKILL?.language ?? "SR3E.skill.addlingo")}
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="item-sheet-component">
            <div class="sr3e-inner-background-container">
                ...
                <div class="sr3e-inner-background">
                    <h1 class="uppercase">
                        {localize(CONFIG.SR3E.SKILL?.language ?? "SR3E.skill.lingos")}
                    </h1>
                    <div class="stat-grid single-column">
