<script lang="ts">
	...
	const typeOptions = [
		{ value: "active",    label: localize(CONFIG.SR3E.SKILL?.active    ?? "SR3E.skill.active") },
		{ value: "knowledge", label: localize(CONFIG.SR3E.SKILL?.knowledge ?? "SR3E.skill.knowledge") },
		{ value: "language",  label: localize(CONFIG.SR3E.SKILL?.language  ?? "SR3E.skill.language") },
	];
	...
	<ItemSheetComponent>
		...
		<div class="stat-grid single-column">
			...
			{#if skillType === "active"}
				<div class="stat-card">
					...
					>
						<option disabled value="">
							{localize(CONFIG.SR3E.SKILL?.linkedAttribute ?? "SR3E.skill.linkedAttribute")}
						</option>
				...
				<!-- Associated dice pool (active only) -->
				<div class="stat-card">
					<select
					...
					>
						<option value="">
							{localize(CONFIG.SR3E.DICE_POOLS?.associateselect ?? "SR3E.dicepools.associateselect")}
						</option>
