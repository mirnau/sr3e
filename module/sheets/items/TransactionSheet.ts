...
import TransactionApp from "../../ui/items/TransactionApp.svelte";
import { SR3EItemBase } from "./SR3EItemBase";

export default class TransactionSheet extends SR3EItemBase {
    #app?: SvelteApp;
    ...
    static get DEFAULT_OPTIONS() {
        return {
            ...
            classes: ["sr3e", "sheet", "staticlayout", "transaction"],
            template: null,
