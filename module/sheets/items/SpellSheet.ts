...
import SpellApp from "../../ui/items/SpellApp.svelte";
import { SR3EItemBase } from "./SR3EItemBase";

export default class SpellSheet extends SR3EItemBase {
    #app?: SvelteApp;
    ...
    static get DEFAULT_OPTIONS() {
        return {
            ...
            classes: ["sr3e", "sheet", "staticlayout", "spell"],
            template: null,
