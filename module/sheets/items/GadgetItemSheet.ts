...
import GadgetApp from "../../ui/items/GadgetApp.svelte";
import { SR3EItemBase } from "./SR3EItemBase";

export default class GadgetItemSheet extends SR3EItemBase {
    #app?: SvelteApp;
    ...
    static get DEFAULT_OPTIONS() {
        return {
            ...
            classes: ["sr3e", "sheet", "staticlayout", "gadget"],
            template: null,
