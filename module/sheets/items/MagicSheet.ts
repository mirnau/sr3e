...
import MagicApp from "../../ui/items/MagicApp.svelte";
import { SR3EItemBase } from "./SR3EItemBase";

export default class MagicSheet extends SR3EItemBase {
    #app?: SvelteApp;
    ...
    static get DEFAULT_OPTIONS() {
        return {
            ...
            classes: ["sr3e", "sheet", "staticlayout", "magic"],
            template: null,
